      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          contentPadding: widget.filled
              ? EdgeInsets.all(LpTextField.filledPadding)
              : EdgeInsets.symmetric(vertical: NcSpacing.smallSpacing),
          isDense: true,
          filled: widget.filled,
          fillColor: widget.fillColor,
          prefix: widget.prefix,
          prefixIcon: widget.prefixIcon != null
              ? LpIcon(widget.prefixIcon, size: widget.fontSize)
              : null,
          suffix: widget.suffix,
          suffixIcon: widget.suffixIcon != null
              ? LpIcon(widget.suffixIcon, size: widget.fontSize)
              : null,
          ...
          errorStyle: NcBaseText.style(
              color: errorColor, fontSize: LpTextField.feedbackFontSize),
          helperStyle: NcBaseText.style(
              color: textColor, fontSize: LpTextField.feedbackFontSize),
