...
class CalendarPlanDropDownInviteUsersUser extends StatefulWidget {
  /// Displays a user that can be invited to the plan.
  const CalendarPlanDropDownInviteUsersUser({Key? key, required this.userId})
      : super(key: key);
  ...
  @override
  State<CalendarPlanDropDownInviteUsersUser> createState() =>
      _CalendarPlanDropDownInviteUsersUserState();
}

class _CalendarPlanDropDownInviteUsersUserState
    extends State<CalendarPlanDropDownInviteUsersUser> {
      ...
      builder: (context, ref, _) {
        ...
        return ConditionalWidget(
          ...
          ifTrue: (context) {
            ...
            var filteredInvites = invites.values
                .where((e) => e.invitee == widget.userId)
                .toList();
            ...
            if (filteredInvites.isNotEmpty) {
              ...
              if (invite.status.isAccepted &&
                  plan.members.containsKey(widget.userId)) {
                color = successColor;
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        NcCaptionText(
                          user!.fullname,
                          fontSize: CalendarPlanDropDownInviteUsersUser
                              .usernameFontSize,
                        ),
                        NcBodyText(
                        ...
                        children: [
                          if (icon != null)
                            LpIcon(icon,
                                color: color,
                                size: scaleIcon(
                                    CalendarPlanDropDownInviteUsersUser
                                        .fontSize)),
                          ...
                          NcCaptionText(
                            ...
                            color: color,
                            fontSize:
                                CalendarPlanDropDownInviteUsersUser.fontSize,
                          ),
                        ],
                      ),
                    ),
