...
class notifications_get_notification extends external_api {
    public static function get_notification_parameters() {
    ...
    public static function get_notification($userid, $notificationid) {
        global $DB;
        global $USER;

        $params = self::validate_parameters(
            self::get_notification_parameters(),
            array('userid' => $userid, 'notificationid' => $notificationid)
        );
    ...
    public static function get_notification_returns() {
