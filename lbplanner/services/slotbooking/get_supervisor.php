 ...
 */
class slotbooking_get_supervisor extends external_api {
    public static function get_supervisor_parameters() {
    ...
    public static function get_supervisor($userid, $teacherid, $slotid) {
        global $DB;

        self::validate_parameters(
                self::get_supervisor_parameters(),
    ...
    public static function get_supervisor_returns() {
