...
$functions = array(
    ...
    'local_lbplanner_feedback_add_feedback' => array(
        'classname' => 'local_lbplanner_services\feedback_add_feedback',
        'methodname' => 'add_feedback',
        'classpath' => 'local/lbplanner/services/feedback/add_feedback.php',
...
$services = array(
    'LB Planner API' => array(
        'functions' => array(
            ...
            'local_lbplanner_add_feedback_user',
            'local_lbplanner_delete_feedback_user',
            'local_lbplanner_get_all_feedback_user',
            'local_lbplanner_get_feedback_user',
            'local_lbplanner_update_feedback_user',
        ),
        'restrictedusers' => 0,
        'enabled' => 1,
        'shortname' => 'lpa'
