...
$services = array(
    'LB Planner API' => array(
        'functions' => array(
            ...
            'local_lbplanner_add_feedback',
            'local_lbplanner_delete_feedback',
            'local_lbplanner_get_all_feedback',
            'local_lbplanner_get_feedback',
            'local_lbplanner_update_feedback',
        ),
        'restrictedusers' => 0,
        'enabled' => 1,
        'shortname' => 'lpa'
