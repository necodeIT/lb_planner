...
class NcCaptionText extends StatelessWidget {
  const NcCaptionText(this.text, {Key? key, this.fontSize, this.buttonText = false, this.overflow = TextOverflow.ellipsis, this.textAlign = TextAlign.left}) : super(key: key);
