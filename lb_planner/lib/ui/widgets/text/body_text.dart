...
class NcBodyText extends StatelessWidget {
  const NcBodyText(this.text, {Key? key, this.fontSize = 20, this.buttonText = false, this.overflow = TextOverflow.ellipsis, this.textAlign = TextAlign.left}) : super(key: key);
