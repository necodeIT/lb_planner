...
class _CalendarPlanDropDownMembersState extends State<CalendarPlanDropDownMembers> {
  ...
  final TextEditingController _addMembersController = TextEditingController();
  ...
  Widget build(context) {
    return Consumer(
      builder: (context, ref, _) {
        ...
        var potentialMembers = users.values.where((user) => _filterSearch(user.id, users, _addMembersController.text)).toList();
              ...
              child: ListView(
                children: [
                  ...
                  ConditionalWidget(
                      ...
                      trueWidget: (_) => LpTextField.filled(
                            controller: _addMembersController,
                            placeholder: t.calendar_plan_dropdown_members_addMember,
                            fontSize: CalendarPlanDropDownBody.fontSize,
                          ),
                      falseWidget: (context) => LpButton.icon(
